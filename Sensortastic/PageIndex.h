...
<html>
  ...
  <body>
    ...
    <p>
      <i class="fa fa-thermometer-half" style="font-size:3.0rem;color:#f0b93a;"></i> 
      <span class="dht-labels">Temperature : </span> 
      <span id="TemperatureValue">0</span>
      <sup class="units">&deg;C</sup>
    </p>
    <p>
      <i class="fa fa-tint" style="font-size:3.0rem;color:#62a1d3;"></i>
  ...
  <p>
    ...
    <span style="font-size:1.0rem;">This system is made by </span>
    <a href="https://github.com/klaasnicolaas" target="_blank" style="font-size:1.0rem;">Klaas Schoute</a>
  </P>
    <script>
